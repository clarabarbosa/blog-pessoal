...
@Table(name = "tb_postagens") // indicar o nome da tabela no bd
public class Postagem {
	...
	@NotBlank(message = "O atributo título é obrigatório!") // "Titulo da postagem"
	@Size(min = 5, max = 100, message = "O atributo titulo deve conter no mínimo 05 e no máximo 100 caracteres")
	private String titulo;
	
	@NotBlank(message = "O atributo texto é obrigatório") // "Titulo da postagem"
